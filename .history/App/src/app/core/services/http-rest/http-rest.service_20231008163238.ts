...
import { AppConfig, APP_DI_CONFIG } from '@app/core/config/app.config';
...
export class HttpRestService {
  ...
  setController(controller: string, customApiUrl: string = '') {
  ...
  getService(param: any | null, dataHeader: any[] | null = null, activeArrayBuffer = false): Observable<any> {
    ...
    return this.httpClient.get(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl), opt)
  }
  createService(body: any, header: any = null): Observable<any> {
    if (header === null) {
      let headers = new HttpHeaders({ 'Content-Type': 'application/json' });
      return this.httpClient.post(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl), body)
    }
    return this.httpClient.post(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl), body, header)
  }

  createServiceWithParams(params: HttpParams): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    let apiUrl = this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl) + "?";
    let paramCopy: any;
    paramCopy = params;
  ...
  updateService(body: any, header: any = null): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.put(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl), body, { headers: headers })
  }
  ...
  patchService(url: string, body: any): Observable<any> {
    return this.httpClient
      .patch(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl), body)
  }

  deleteService(id: any): Observable<any> {
    let headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.delete(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl) + '/' + id, { headers: headers })
  }
  ...
  deleteWhitService(param: any | null): Observable<any> {
    ...
    return this.httpClient.delete(this.apiUrlSetting.getQueryApiUrl(this.controller, this.customApiUrl), { params: params })
  }
  ...
  private handleError(error: any) {
    ...
    console.log("eRRRRRRRRROR");
      /*this.toasterService.showServerError(errMsg);
