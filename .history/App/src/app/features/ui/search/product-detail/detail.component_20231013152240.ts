...
export class ProductDetailComponent implements OnInit {
  ...
  getProductByTypeId() {
    this.ProductService.get({}, null, "/products/by-typeId?typeId=" + this.typeId).subscribe(
      data => { 
  ...
  geProducts() {
    this.ProductService.get({}, null, "/products/find-hts?typeId=" + this.typeId).subscribe(
      data => { 
        this.product = data.content;
      },
      error => {
