...
export class ProductDetailComponent implements OnInit {
  ...
  getTypeIdContries() {
    this.ProductService.get({}, null, "/products/typeId-countries?typeId=" + this.typeId+"&countryId="+this.countryId).subscribe(
      data => { 
        this.contries.push({
          id: "",
          code: "", 
  ...
  getProductByTypeId() {
    this.ProductService.get({}, null, "/products/by-typeId?typeId=" + this.typeId+"&countryId="+this.countryId).subscribe(
      data => { 
  ...
  geProducts() {
    this.ProductService.get({}, null, "/products/find-hts?typeId=" + this.typeId+"&countryId="+this.countryId).subscribe(
      data => { 
