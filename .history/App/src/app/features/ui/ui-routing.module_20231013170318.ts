...
const routes: Routes = [
  ...
  { path: "AboutUs",  title: "درباره ما" , component: AboutComponent ,canActivate: [AuthGuard]}, 
  ...
  { path: "SearchEngine/productCodeDetail/:htsCode/:countryCode",  title: "جستجوی محصول" , component: ProductDetailComponent }, 
  { path: "SearchEngine/productRequiermentDetail/:htsCode/:countryCode",  title: "جستجوی محصول" , component: ProductDetailComponent }, 
  { path: "SearchEngine/productTarrifsDetail/:htsCode/:countryCode",  title: "جستجوی محصول" , component: ProductDetailComponent }, 
