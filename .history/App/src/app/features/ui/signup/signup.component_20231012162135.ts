...
export class SignupComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.CustomerService.post(this.pageForm.value , null , "/customers/register").subscribe(data => {
      console.log("===============");
      console.log(data);
  ...
  doRegister() {
    ...
    if (!this.pageForm.valid) {
      ...
      this.blockUI.start();
      this.CustomerService.get(this.pageForm.value , null , "/customers/register").subscribe(data => {
        console.log(data);
        this.toastr.info('ورودی ها نامعتبر هستند');
        this.blockUI.stop();
      });
    }
  }
